...
public class ButtonsText {
    ...
    public static final String HOW_TO_GET_DOG = bundle.getString("HOW_TO_GET_DOG_BUTTON");
    public static final String SEND_REPORT = bundle.getString("SEND_REPORT_BUTTON");
